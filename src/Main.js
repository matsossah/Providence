    ...
    return (
      <Router>
        <Scene key="root">
          ...
          <Scene key="reservation" direction="vertical" panHandlers={null} component={Reservation} title='Reservation' hideNavBar={false} backButtonImage={require('./assets/hamburger.png')} onBack={()=> Actions.authentication()} rightButtonImage={require('./assets/close.png')} onRight={()=> Actions.pop()} leftButtonStyle={styles.navbarButton} rightButtonIconStyle={styles.tallNloseButton} navigationBarStyle={styles.navBar} titleStyle={styles.homeTitle}/>
          <Scene key="show" component={Show} title='Info' hideNavBar={false} navigationBarStyle={styles.navBar} backButtonImage={require('./assets/back.png')} leftButtonStyle={styles.navbarButton} titleStyle={styles.title} rightButtonImage={require('./assets/location.png')} onRight={()=> Actions.help()} rightButtonIconStyle={styles.navbarButton}/>
          ...
          <Scene key="food" component={Food} title='Food' hideNavBar={false} navigationBarStyle={styles.navBar} backButtonImage={require('./assets/back.png')} leftButtonStyle={styles.navbarButton} titleStyle={styles.title} rightButtonImage={require('./assets/location.png')} onRight={()=> Actions.help()} rightButtonIconStyle={styles.tallNavbarButton} />
          ...
          <Scene key="pets" component={Pets} title='Pets' hideNavBar={false} navigationBarStyle={styles.navBar} backButtonImage={require('./assets/back.png')} leftButtonStyle={styles.navbarButton} titleStyle={styles.title} rightButtonImage={require('./assets/location.png')} onRight={()=> Actions.help()} rightButtonIconStyle={styles.tallNavbarButton} />
          ...
          <Scene key="pubs" component={Pubs} title='Pubs' hideNavBar={false} navigationBarStyle={styles.navBar} backButtonImage={require('./assets/back.png')} leftButtonStyle={styles.navbarButton} titleStyle={styles.title} rightButtonImage={require('./assets/location.png')} onRight={()=> Actions.help()} rightButtonIconStyle={styles.tallNavbarButton} />
